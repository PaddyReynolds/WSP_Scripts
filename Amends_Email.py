...
text = (r"""Hello All<br><br>
     ...
     Go Fuck Yourself San Diego,<br><br>
     <b>Patrick Reynolds</b><br>
     GIS Consultant<br>Bsc,Msc""".format(Hs2A_Parcel_Count,Hs2A_Licence_Count,Hs2B_Parcel_Count,Hs2B_Licence_Count,Hs2B_L3_Parcel_Count,Hs2B_L3_Licence_Count,WorkFolder2))

outlook = win32.Dispatch('outlook.application')
mail = outlook.CreateItem(0)
mail.To = 'Kane.Russell@wsp.com; Adil.Toorawa@wsp.com; Ollie.Brown@wsp.com; Patrick.Reynolds@wsp.com; Kuhu.Dahiya@wsp.com; Boglarka.Csomos@wsp.com; Vasiliki.Ketsetzopoulou@wsp.com; Shrabanti.Hira@wsp.com; Alexandra.Hajok@wsp.com; David.Evans2@wsp.com; Anna.Prior@wsp.com'
