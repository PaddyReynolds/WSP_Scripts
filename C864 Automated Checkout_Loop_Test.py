...
for i in checkout_Loop:
    ...
    checkout_Name_Date = 'GI__Relate_24052022_'
    ...
    layers_to_Take = r'Database Connections\HS2-Phase2B-Manchester-M2M3-Lot1-GSS.sde\HS2phase2B.GSS.STATUTORY_PROCESSES'
