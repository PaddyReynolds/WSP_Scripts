...
#####
LAP = r'C:\Users\UKPXR011\Desktop\Current Work\2A\GDD\Extract\12042022.gdb\LAP'
...
#tool parameters
#csvfile=  r'C:\Users\UKPXR011\Desktop\Current Work\2A\Notice Plans\csv\A101_042_RS02.csv'
...
csvList = [r'C:\Users\UKPXR011\Desktop\Current Work\2A\Notice Plans\csv\A101_070.csv']
pro = 'PR'
che = 'HS'
prod = "'{0}'" .format(pro)
chec = "'{0}'" .format(che)
