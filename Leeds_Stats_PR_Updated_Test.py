...
workspace = r"C:\Users\UKPXR011\Desktop\Stats\05082020"
...
#Calculate_Argeed_Expired = arcpy.CalculateField_management(Select_AccessLicence_data,"Status",expressionNotIssuedAcre,"Python_9.3",CodeblockNotIssuedAcre)
...
Select_CP2_1_250_Status_Areas = arcpy.Select_analysis(Select_AccessLicence_data,str(Working)+"\Select_CP2_1_250_Areas","""In_CP2_1_250_Limits_Int = 1""")
...
Select_L3L4_Status_Areas = arcpy.Select_analysis(Select_AccessLicence_data,str(Working)+"\Select_L3L4_Areas","""In_L3L4_Limits_Int = 1""")
Select_MML_Status_Areas = arcpy.Select_analysis(Select_AccessLicence_data,str(Working)+"\Select_MML_Areas","""In_MML_Limits_Int = 1 """)
