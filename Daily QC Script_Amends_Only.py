...
for gap in Gap_check:
    if gap != limit_copy_2a:
        ...
        arcpy.RepairGeometry_management(union_Output)
...
Hs2B_L1_SFG_Amends = r"Database Connections\HS2-Phase2B-Manchester-M2M3-Lot1-GSS.sde\HS2phase2B.GSS.STATUTORY_PROCESSES\HS2phase2B.GSS.SafeguardingParcelAmends"
...
Hs2B_L1_SFGcount =[row for row in arcpy.da.SearchCursor(Hs2B_L1_SFG_Amends,'ActionedBy',"ActionedBy IS NULL")]
SFG_count2B_L1 = len(Hs2B_L1_SFGcount)
...
Hs2B_L3_SFG_Amends = r"Database Connections\HS2-Phase2B-Leeds-L3L4-Lot3-GSS.sde\HS2phase2B_WSP.GSS.STATUTORY_PROCESSES\HS2phase2B_WSP.GSS.SafeguardingParcelAmends "
...
Hs2B_L3_SFGcount = [row for row in arcpy.da.SearchCursor(Hs2B_L3_SFG_Amends,'ActionedBy',"ActionedBy IS NULL")]
SFG_count2B_L3 = len(Hs2B_L3_SFGcount)
...
Hs2B_SFG_Count = str(str(SFG_count2B_L1) + " outstanding Safeguarding amends")
...
Hs2B_L3_SFG_Count = str(str(SFG_count2B_L3) + " outstanding Safeguarding amends")
...
if 150 <= int(SFG_count2B_L3) <= 299:
    HS2B_lot3_SFG_email = '<font color="orange"><b>' + Hs2B_L3_SFG_Count + '</b></font>'
else:
    if int(SFG_count2B_L3) >= 300:
        HS2B_lot3_SFG_email = '<font color="red"><b>' + Hs2B_L3_SFG_Count + '</b></font>'
    else:
        HS2B_lot3_SFG_email = Hs2B_L3_SFG_Count
...
if 150 <= int(SFG_count2B_L1) <= 299:
    HS2B_lot1_SFG_email = '<font color="orange"><b>' + Hs2B_SFG_Count + '</b></font>'
    print (HS2B_lot1_SFG_email)
else:
    if int(SFG_count2B_L1) >= 300:
        HS2B_lot1_SFG_email = '<font color="red"><b>' + Hs2B_SFG_Count + '</b></font>'
        print (HS2B_lot1_SFG_email)
    else:
        HS2B_lot1_SFG_email = Hs2B_SFG_Count
        print (HS2B_lot1_SFG_email)
...
text = (r"""Hello All<br><br>
     ...
     Phase 2B Lot 3:
     <br>{}<br>{}<br>{}<br><br>
     There were a lot of amends that had actioned by in the coloumn but werent actioned, this has meant we have been too optomistic with Leeds until now!<br><br>
     Kind regards,<br><br>
     <b>Patrick Reynolds</b><br>
     GIS Consultant<br>Bsc,Msc, FRGS""".format(HS2A_Parcel_email,HS2A_Licence_email,value3,email_null_output,HS2B_lot1_parcel_email,HS2B_lot1_licence_email,HS2B_lot1_SFG_email,HS2B_lot3_parcel_email,HS2B_lot3_licence_email,HS2B_lot3_SFG_email))
