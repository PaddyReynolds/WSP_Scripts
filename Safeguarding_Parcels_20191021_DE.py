...
workspace = r"C:\Users\ukdxe008\Desktop\Safeugarding_2.0\Data\Parcel_Scenario_Run"

# Change the name of the folder to the Project name
projectname = "HS2A_Safeguarding_2019"
...
HMLRTitles = r"C:\Users\ukdxe008\Desktop\Safeugarding_2.0\Data\Super_Parcel_Work\DE_Checkout_20191011.gdb\HMLR_Parcels"
LandOwnershipParcels = r"C:\Users\ukdxe008\Desktop\Safeugarding_2.0\Data\Script_Working_Data\Script_Working.gdb\Super_Parcels"
NewSafeguardingZones = r"C:\Users\ukdxe008\Desktop\Safeugarding_2.0\C863-MCL-GI-GDD-000-000005_P06\C863-MCL-GI-GDD-000-000005_P06\Y19W43.gdb\HS2_HSTWO_SafeguardingAndZonedPropertySchemes_Ply"
OldSafeguardingZones = r"C:\Users\ukdxe008\Desktop\Safeugarding_2.0\Data\Script_Working_Data\Data.gdb\HS2_HSTWO_SafeguardingAndZonedPropertySchemes_Ply"
LocalAuthority = r"C:\Users\ukdxe008\Desktop\Safeugarding_2.0\Data\Script_Working_Data\Script_Working.gdb\Parish_Data"
Constituency = r"C:\Users\ukdxe008\Desktop\Safeugarding_2.0\Data\Script_Working_Data\Constituencies.gdb\westminster_const_region"
AddressPoly = r"C:\Users\ukdxe008\Documents\Projects\ABP_Processed_2019\HS2_AddressBasePremium2019_Processed.gdb\HS2_AddressBasePremium2019_Processed.gdb\ProcessedABP_Polygons"
AddressNonPoly = r"C:\Users\ukdxe008\Documents\Projects\ABP_Processed_2019\HS2_AddressBasePremium2019_Processed.gdb\HS2_AddressBasePremium2019_Processed.gdb\ProcessedABP_NonPolygons"
...
constituencyintersect = arcpy.Intersect_analysis([deleteconclafield,Constituency], str(Working)+"\Parcel_constituencyIntersect", "ALL", "", "INPUT")
...
addscenariofield = arcpy.AddField_management(deleteconccfield, scenario, FieldType, "",field_alias="Scenario")
...
with arcpy.da.UpdateCursor(deleteconccfield, [newsurfaceareafield,oldsurfaceareafield,newsubsurfaceareafield,oldsubsurfaceareafield,newEHPZ1areafield,oldEHPZ1areafield,newEHPZ2areafield,oldEHPZ2areafield,newRSZareafield,oldRSZareafield,newHOP1areafield,oldHOP1areafield,newHOP2areafield,oldHOP2areafield,newHOP3areafield,oldHOP3areafield,AddressPresentField,scenario,scenariotext,gisreview,exclusion,HOPScenario,HOPScenariotext]) as cursor:
    for row in cursor:
        ...
        if (row[0] - row[1] >=1 and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] < 1):
            row[17] = 1
            row[18] = 'Within December 2019 Surface Safeguarding only, where Surface Safeguarding has increased by greater than 1sqm'
        if (row[0] - row[1] >=-1 and row[0] - row[1] <=1 and row[0] - row[1] <>0 and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] < 1):
            row[17] = 18
            row[18] = 'Within December 2019 Surface Safeguarding only, and no change between this and July 2017 Surface Safeguarding'
            row[19] = 'Moved from Scenario 1 to Scenario 18 because the change is not considered significant as the area value is within 1sqm of July 2017 Surface Safeguarding Zone'
        ...
        if (row[0] - row[1] <=-1 and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] < 1):
            row[17] = 2
            row[18] = 'Within December 2019 Surface Safeguarding only, where Surface Safeguarding has decreased by greater than 1sqm'
        # Scenario 3 Land with and without an address within it and within 2019 Surface Safeguarding where the zone area has increased and EHPZ1
        if ((row[0] - row[1] <=-1 or row[0] - row[1] >=1) and row[0] > 1 and row[2] < 1 and row[4] > 1 and row[6] < 1 and row[8] < 1):
            row[17] = 3
            row[18] = 'Within December 2019 Surface Safeguarding and Enhanced Homeowner Protection Zone 1 only, where Surface Safeguarding has increased or decreased by greater than 1sqm'
        # Scenario 4 Land with and without an address within it and within 2019 Surface Safeguarding where the zone area has increased and EHPZ2
        if ((row[0] - row[1] <=-1 or row[0] - row[1] >=1) and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] > 1 and row[8] < 1):
            row[17] = 4
            row[18] = 'Within December 2019 Surface Safeguarding and Enhanced Homeowner Protection Zone 2 only, where Surface Safeguarding has increased or decreased by greater than 1sqm'
        # Scenario 5 Land with an address within it and within 2019 Surface Safeguarding and RSZ
        if (row[16] == 'Yes' and (row[0] - row[1] <=-1 or row[0] - row[1] >=1) and row[0] - row[1] <>0 and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] > 1):
            row[17] = 5
            row[18] = 'Within December 2019 Surface Safeguarding and Rural Support Zone only'
        if (row[16] == 'No' and (row[0] - row[1] <=-1 or row[0] - row[1] >=1) and row[0] - row[1] <>0 and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] > 1):
            row[17] = 1
            row[18] = 'Within December 2019 Surface Safeguarding only'
            row[19] = 'Moved from Scenario 5 to Scenario 1 as no address lies within the Land Ownership Parcel'
        if (row[16] == 'No' and (row[0] - row[1] >=-1 or row[0] - row[1] <=1) and row[0] - row[1] <>0 and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] > 1):
            row[17] = 18
            row[18] = 'Within December 2019 Surface Safeguarding only, and no change between this and July 2017 Surface Safeguarding'
            row[19] = 'Moved from Scenario 4 to Scenario 18 because the change is not considered significant as the area value is within 1sqm of July 2017 Surface Safeguarding Zone and the parcel contains no address'
        # Scenario 6 Land with an address within it and within 2019 Surface Safeguarding, RSZ and EHPZ1
        if (row[16] == 'Yes' and (row[0] - row[1] <=-1 or row[0] - row[1] >=1) and row[0] - row[1] <>0 and row[0] > 1 and row[2] < 1 and row[4] > 1 and row[6] < 1 and row[8] > 1):
            row[17] = 6
            row[18] = 'Within December 2019 Surface Safeguarding, Rural Support Zone and Enhanced Homeowner Protection Zone 1 only'
        if (row[16] == 'No' and (row[0] - row[1] <=-1 or row[0] - row[1] >=1) and row[0] - row[1] <>0 and row[0] > 1 and row[2] < 1 and row[4] > 1 and row[6] < 1 and row[8] > 1):
            row[17] = 3
            row[18] = 'Within December 2019 Surface Safeguarding and Enhanced Homeowner Protection Zone 1 only, where Surface Safeguarding has increased or decreased by greater than 1sqm'
            row[19] = 'Moved from Scenario 6 to Scenario 3 as no address lies within the Land Ownership Parcel'
        if (row[16] == 'No' and (row[0] - row[1] >=-1 or row[0] - row[1] <=1) and row[0] - row[1] <>0 and row[0] > 1 and row[2] < 1 and row[4] > 1 and row[6] < 1 and row[8] > 1):
            row[17] = 18
            row[18] = 'Within December 2019 Surface Safeguarding only, and no change between this and July 2017 Surface Safeguarding'
            row[19] = 'Moved from Scenario 6 to Scenario 18 because the change is not considered significant as the area value is within 1sqm of July 2017 Surface Safeguarding Zone and the parcel contains no address'
        # Scenario 7 Land with an address within it and within 2019 Surface Safeguarding, RSZ and EHPZ1
        if (row[16] == 'Yes' and (row[0] - row[1] <=-1 or row[0] - row[1] >=1) and row[0] - row[1] <>0 and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] > 1 and row[8] > 1):
            row[17] = 7
            row[18] = 'Within December 2019 Surface Safeguarding and Rural Support Zone only'
        if (row[16] == 'No' and (row[0] - row[1] <=-1 or row[0] - row[1] >=1) and row[0] - row[1] <>0 and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] > 1 and row[8] > 1):
            row[17] = 4
            row[18] = 'Within December 2019 Surface Safeguarding and Enhanced Homeowner Protection Zone 2 only, where Surface Safeguarding has increased or decreased by greater than 1sqm'
            row[19] = 'Moved from Scenario 7 to Scenario 4 as no address lies within the Land Ownership Parcel'
        if (row[16] == 'No' and (row[0] - row[1] >=-1 or row[0] - row[1] <=1) and row[0] - row[1] <>0 and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] > 1 and row[8] > 1):
            row[17] = 18
            row[18] = 'Within December 2019 Surface Safeguarding only, and no change between this and July 2017 Surface Safeguarding'
            row[19] = 'Moved from Scenario 7 to Scenario 18 because the change is not considered significant as the area value is within 1sqm of July 2017 Surface Safeguarding Zone and the parcel contains no address'
        # Scenario 8 Land within EHPZ2
        if (row[0] < 1 and row[2] < 1 and row[4] < 1 and row[6] > 1 and row[8] < 1):
            row[17] = 8
            row[18] = 'Within December 2019 Enhanced Homeowner Protection Zone 2 only'
        # Scenario 9 Land with an address within it and within 2019 EHPZ2 and RSZ
        if (row[16] == 'Yes' and row[0] < 1 and row[2] < 1 and row[4] < 1 and row[6] > 1 and row[8] > 1):
            row[17] = 9
            row[18] = 'Within December 2019 Enhanced Homeowner Protection Zone 2 and Rural Support Zone only'
        if (row[16] == 'No' and row[0] < 1 and row[2] < 1 and row[4] < 1 and row[6] > 1 and row[8] > 1):
            row[17] = 8
            row[18] = 'Within December 2019 Enhanced Homeowner Protection Zone 2 only'
            row[19] = 'Moved from Scenario 9 to Scenario 8 as no address lies within the Land Ownership Parcel'
        # Scenario 10 Land within Surface Safeguarding and Subsurface Safeguarding
        if ((row[0] - row[1] <=-1 or row[0] - row[1] >=1) and (row[2] - row[3] <=-1 or row[2] - row[3] >=1) and row[0] > 1 and row[2] > 1 and row[4] < 1 and row[6] < 1 and row[8] < 1):
            row[17] = 10
            row[18] = 'Within December 2019 Surface Safeguarding and Subsurface Safeguarding only'
        # Scenario 11 Land previously within Surface Safeguarding and now in Subsurface Safeguarding
        if (row[0] < 1 and row[1] > 1 and row[2] > 1 and row[3] < 1 and row[4] < 1 and row[5] < 1 and row[6] < 1 and row[7] < 1 and row[8] < 1 and row[9] < 1):
            row[17] = 11
            row[18] = 'Previously within Surface Safeguarding only and within December 2019 Subsurface Safeguarding only'
        # Scenario 12 Land within Subsurface Safeguarding
        if ((row[2] - row[3] <=-1 or row[2] - row[3] >=1) and row[2] - row[3] <>0 and row[0] < 1 and row[2] > 1 and row[4] < 1 and row[6] < 1 and row[8] < 1):
            row[17] = 12
            row[18] = 'Within December 2019 Subsurface Safeguarding only'
        if ((row[2] - row[3] >=-1 or row[2] - row[3] <=1) and row[2] - row[3] <>0 and row[0] < 1 and row[2] > 1 and row[4] < 1 and row[6] < 1 and row[8] < 1):
            row[17] = 20
            row[18] = 'Within December 2019 Subsurface Safeguarding only, and no change between this and July 2017 Subsurface Safeguarding'
            row[19] = 'Moved from Scenario 12 to Scenario 20 because the change is not considered significant as the area value is within 1sqm of July 2017 Subsurface Safeguarding Zone'
        # Scenario 13 Land within Subsurface Safeguarding
        if (row[16] == 'Yes' and (row[2] - row[3] <=-1 or row[2] - row[3] >=1) and row[2] - row[3] <>0 and row[0] < 1 and row[2] > 1 and row[4] < 1 and row[6] < 1 and row[8] > 1):
            row[17] = 13
            row[18] = 'Within December 2019 Subsurface Safeguarding and Rural Support Zone only'
        if (row[16] == 'No' and (row[2] - row[3] <=-1 or row[2] - row[3] >=1) and row[2] - row[3] <>0 and row[0] < 1 and row[2] > 1 and row[4] < 1 and row[6] < 1 and row[8] > 1):
            row[17] = 12
            row[18] = 'Within December 2019 Subsurface Safeguarding only'
            row[19] = 'Moved from Scenario 13 to Scenario 12 as no address lies within the Land Ownership Parcel'
        # Scenario 14 Land previously within Surface Safeguarding and now in No Zones
        if (row[1] > 1 and row[0] < 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] < 1):
            row[17] = 14
            row[18] = 'Previously within Surface Safeguarding and in No Zone in December 2019'
        # Scenario 15 Land containing an address and previously within RSZ and now in No Zones
        if (row[16] == 'Yes' and row[9] > 1 and row[0] < 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] < 1):
            row[17] = 15
            row[18] = 'Previously within Rural Support Zone and containing an address and in No Zone in December 2019'
        ...
        if (row[16] == 'Yes' and (row[11] > 1 or row[13] > 1 or row[15] > 1) and row[0] < 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] < 1 and row[10] < 1 and row[12] < 1 and row[14] < 1):
            row[17] = 16
            row[18] = 'Previously within HOP and containing an address and in No Zone in December 2019'
        # Scenario 17 Land previously within Rural Support Zone and within December 2019 Rural Support Zone only
        if (row[16] == 'Yes' and row[8] == row[9] and row[0] < 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] > 1):
            row[17] = 17
            row[18] = 'Within December 2019 Rural Support Zone and containing an address, and no change between this area value and July 2017 Rural Support Zone'
        if (row[16] == 'No' and row[8] == row[9] and row[0] < 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] > 1):
            row[17] = 17
            row[18] = 'Within December 2019 Rural Support Zone and without an address, and no change between this area value and July 2017 Rural Support Zone'
        # Scenario 18 Land previously within Surface Safeguarding and within December 2019 Surface Safeguarding only
        if (row[0] == row[1] and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] < 1):
            row[17] = 18
            row[18] = 'Within December 2019 Surface Safeguarding only, and no change between this and July 2017 Surface Safeguarding'
        # Scenario 19 Land previously within Rural Support Zone and within December 2019 Rural Support Zone only
        if (row[16] == 'Yes' and row[0] == row[1] and row[8] == row[9] and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] > 1):
            row[17] = 19
            row[18] = 'Within December 2019 Surface Safeguarding and Rural Support Zone and containing an address, and no change between this area value and July 2017 Surface Safeguarding and Rural Support Zone'
        if (row[16] == 'No' and row[0] == row[1] and row[8] == row[9] and row[0] > 1 and row[2] < 1 and row[4] < 1 and row[6] < 1 and row[8] > 1):
            row[17] = 17
            row[18] = 'Within December 2019 Rural Support Zone and without an address, and no change between this area value and July 2017 Rural Support Zone'
            row[19] = 'Moved from Scenario 19 to Scenario 17 because there is no address within the parcel'
        # Scenario 20 Land previously within Subsurface Safeguarding and within December 2019 Subsurface Safeguarding only
        if (row[2] == row[3] and row[0] < 1 and row[2] > 1 and row[4] < 1 and row[6] < 1 and row[8] < 1):
            row[17] = 20
            row[18] = 'Within December 2019 Subsurface Safeguarding only, and no change between this and July 2017 Subsurface Safeguarding'
        # Scenario 21 Land previously within Rural Support Zone and within December 2019 Rural Support Zone only
        if (row[16] == 'Yes' and row[2] == row[3] and row[8] == row[9] and row[0] < 1 and row[2] > 1 and row[4] < 1 and row[6] < 1 and row[8] > 1):
            row[17] = 21
            row[18] = 'Within December 2019 Surface Safeguarding and Rural Support Zone and containing an address, and no change between this area value and July 2017 Subsurface Safeguarding and Rural Support Zone'
        if (row[16] == 'No' and row[2] == row[3] and row[8] == row[9] and row[0] < 1 and row[2] > 1 and row[4] < 1 and row[6] < 1 and row[8] > 1):
            row[17] = 20
            row[18] = 'Within December 2019 Subsurface Safeguarding only, and no change between this and July 2017 Subsurface Safeguarding'
            row[19] = 'Moved from Scenario 21 to Scenario 20 because there is no address within the parcel'
        # Scenario 22 Land previously within EHPZ1 and within December 2019 EHPZ1 only
        if (row[4] == row[5] and row[0] < 1 and row[2] < 1 and row[4] > 1 and row[6] < 1 and row[8] < 1):
            row[17] = 22
            row[18] = 'Within December 2019 Enhanced Homeowner Protection Zone 1 only, and no change between this and July 2017 Enhanced Homeowner Protection Zone 1'
        # Scenario 23 Land previously within EHPZ1 and within December 2019 EHPZ1 only
        if (row[16] == 'Yes' and row[4] == row[5] and row[8] == row[9] and row[0] < 1 and row[2] < 1 and row[4] > 1 and row[6] < 1 and row[8] > 1):
            row[17] = 23
            row[18] = 'Within December 2019 Enhanced Homeowner Protection Zone 1 and Rural Support Zone only, and no change between this and July 2017 Enhanced Homeowner Protection Zone 1 and Rural Support Zone'
        if (row[16] == 'No' and row[4] == row[5] and row[8] == row[9] and row[0] < 1 and row[2] < 1 and row[4] > 1 and row[6] < 1 and row[8] > 1):
            row[17] = 22
            row[18] = 'Within December 2019 Enhanced Homeowner Protection Zone 1 only, and no change between this and July 2017 Enhanced Homeowner Protection Zone 1'
            row[19] = 'Moved from Scenario 23 to Scenario 22 because there is no address within the parcel'
        # Scenario 24 Land and addresses previously within HOP and within December 2019 HOP only
        if (row[16] == 'Yes' and (row[10] > 1 or row[12] > 1 or row[14] > 1)):
            row[21] = 24
            row[22] = 'Within December 2019 Homeowner Protection Zones only'
        if (row[16] == 'No' and (row[10] > 1 or row[12] > 1 or row[14] > 1)):
            row[21] = 24
            row[22] = 'Within December 2019 Homeowner Protection Zones only but no dwelling'
        # Scenario 25 Excluded from Scenarios because intersections with all zones are less than 1sqm so likely slivers
