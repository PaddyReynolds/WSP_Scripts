...
#working_gdb = arcpy.GetParameterAsText(0)
working_gdb = r'C:\Users\UKPXR011\Desktop\Scripts\Noitce Plans\Rae\HS2temp_VM.gdb'

#paths and databases
arcpy.env.workspace = working_gdb
tempfolder = working_gdb

#####
#LAP = arcpy.GetParameterAsText(1)
LAP = r'C:\Users\UKPXR011\Documents\ArcGIS\FeatureServiceLocalEdits\HS2_Phase1_South_HS2_Phase2a_WSP_Feature\fs7D7D03A8527440F9AE65AD11E536D870.gdb\LandAcquisitionParcels_WSP'

#####
districts = working_gdb+"\\Districts_2a"
vessel = working_gdb+"\\NPvessel"
tmply = working_gdb+"\\templayer"


#tool parameters
#csvfile=  arcpy.GetParameterAsText(2)
csvfile = r'C:\Users\UKPXR011\Desktop\Scripts\Noitce Plans\A101_828.csv'
outputfc = working_gdb +"\\newnps"
outputex = working_gdb + "\\newnpsextents"
outputex_combined =  working_gdb + "\\newnpsextents_Combined"
...
file_Path = arcpy.GetParameterAsText(3)
arcpy.AddMessage(file_Path)
newFolder = os.path.join(file_Path , laanum)
#newFolder = file_Path + "\\" + laanum
arcpy.AddMessage(newFolder)
#templateMXD = arcpy.GetParameterAsText(4)
templateMXD = r'C:\Users\UKPXR011\Desktop\Scripts\Noitce Plans\Sch2_Template.mxd'
newMxd = newFolder + "\\" + laanum + ".mxd"
newGDB = laanum + ".gdb"
oldPath = working_gdb + "\HS2temp_VM.gdb"
newPath =newFolder + "\\" + newGDB

OldVessel = working_gdb + "\\NPvessel"
NewVessel = newPath  +'\\'+'NPvessel'
OldExtents =  working_gdb + "\\newnpsextents_Combined"
