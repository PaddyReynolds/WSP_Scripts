...
gdb = r'C:\Users\UKPXR011\Desktop\Safeguarding\SOP\Manchester_SOPs\RSZ_Update\RSZ_UPDATE_04032020\Scratch.gdb'
finished = r'C:\Users\UKPXR011\Desktop\Safeguarding\SOP\Manchester_SOPs\RSZ_Update\RSZ_UPDATE_04032020\SLOPS.gdb'
workspace= r'C:\Users\UKPXR011\Desktop\Safeguarding\SOP\Manchester_SOPs\RSZ_Update\RSZ_UPDATE_04032020\Extract.gdb'

fc1= r'C:\Users\UKPXR011\Desktop\Safeguarding\SOP\Manchester_SOPs\RSZ_Update\RSZ_UPDATE_04032020\Extract.gdb\STATUTORY_PROCESSES\LandOwnershipParcels'

fc2= r'C:\Users\UKPXR011\Desktop\Safeguarding\SOP\Manchester_SOPs\RSZ_Update\RSZ_UPDATE_04032020\Extract.gdb\STATUTORY_PROCESSES\HMLR_Parcels'

fc3 = r'C:\Users\UKPXR011\Desktop\Safeguarding\SOP\Manchester_SOPs\RSZ_Update\RSZ_UPDATE_04032020\Extract.gdb\STATUTORY_PROCESSES\relLandOwnership_HMLR'

fc4 = gdb +"\SLOP_Input_LOP"

fc5 = gdb +"\SLOP_Input_LOP_Temp"

fc6 = gdb+"\Current_Safeguarding"

fc8 = gdb+"\SG_Current_Intersect"

fc9 = gdb+"\SG_Current_Intersect_Dissolve"
...
LOP_Unique_Fields = ['GlobalID','LOP_Unique_ID','RSZ']
...
print "Updating RSZ Safegaurding and LOP"
#Intersect and Dissolve the Old Safegaurding Area
arcpy.Intersect_analysis([fc1,fc17],fc18)
arcpy.Dissolve_management(fc18, fc19,'OwnershipReferenceNumber')
...
JoinFields = ['OwnershipReferenceNumber','OBJECTID']
Update_Fields = ['OwnershipReferenceNumber','Include','RSZ']
# Use list comprehension to build a dictionary from a da SearchCursor
