...
workspace = r'\\uk.wspgroup.com\\central data\\Projects\\62240xxx\\62240842 - HS2 2A Hybrid Bill\\03_Technical\\11_GSS\\03 - MXD\\01 Acquisitions\\Notice\\Noitce_Plan_Tool\\Input_Data\\HS2temp_VM.gdb'
#paths and databases
arcpy.env.workspace = workspace
tempfolder = workspace

#####
LAP = r'C:\\Users\\UKPXR011\\Documents\\ArcGIS\\FeatureServiceLocalEdits\\HS2_Phase1_South_HS2_Phase2a_Feature\\fs042B6970285E4ECEA3D4A07A40A4DF3B.gdb\\LANDACQUISITIONPARCELS'


#####
districts = workspace + '\\Districts_2a'
vessel = workspace + '\\NPvessel'
tmply = workspace +'\\templayer'


#tool parameters
csvfile=  r'C:\\Users\\UKPXR011\\Desktop\\Current Work\\2A\Notice Plans\\A101_032\\A101_032.csv'
outputfc = workspace + '\\newnps'
outputex = workspace + '\\newnpsextents'
