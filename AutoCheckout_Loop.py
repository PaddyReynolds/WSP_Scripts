...
for i in checkout_Loop:
    ...
    #Create work space
    desktopPath = r"\\cormplbrbs1.corp.pbwan.net\\Shared\\LandAspects\\GSS\\Admin\\Patrick\\Safegaurding Amends\\Checkouts\\" + str(i)
    ...
    Check_Out_Name = "SG_ICRC_Checkout_" + str(i)
